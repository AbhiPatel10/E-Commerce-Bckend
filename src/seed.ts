...
import { Admin, Category, Product, Image, ProductStatus } from "./entities";
...
const products = [
  {
    ...
    price: 1890,
    description:
      "The Gucci Marmont bag has been crafted in Italy from chevron-quilted leather and accented with the brand's iconic 'GG' plaque. This timeless piece features a sliding chain strap that can be worn on the shoulder or cross-body, making it versatile for any occasion.",
    shortDescription: "Italian leather with iconic GG plaque",
    categoryName: "Bags",
    stock: 5,
    features: [
      "Chevron-quilted leather",
      "Antique gold-toned hardware",
      "Microfiber lining",
      "Internal open pocket",
    ],
    imageUrls: [
  ...
  },
  {
    ...
    price: 45,
    description:
      "An essential for every wardrobe, this Calvin Klein t-shirt is cut from soft cotton-jersey for a regular fit. The minimalist design is finished with the brand's logo discreetly embroidered on the chest. Perfect for layering or wearing solo with jeans.",
  ...
  },
  {
    ...
    price: 180,
    description:
      "The Air Jordan 1 Retro High OG delivers heritage style with premium leather, comfortable cushioning and classic design details. Since its debut in 1985, this sneaker has revolutionized the sport and culture of basketball.",
  ...
  },
  {
    ...
    price: 18,
    description:
      "Add a touch of sophistication to your ensemble with this Emporio Armani scarf. Crafted from pure silk, it features a subtle logo pattern and delicate fringed edges. Lightweight yet warm, it's the perfect accessory for transitional weather.",
  ...
  },
  {
    ...
    price: 130,
    description:
      "The Nike Air Max 90 stays true to its OG running roots with the iconic Waffle outsole, stitched overlays and classic TPU accents. Fresh details give a modern look while Max Air cushioning adds comfort to your journey.",
  ...
  },
  {
    ...
    price: 2800,
    description:
      "This double-breasted coat from Gucci captures the house's retro-inflected aesthetic. Tailored in Italy from insulating wool, it has a smart peak lapel and golden buttons embossed with the brand's logo.",
  ...
  },
  {
    ...
    price: 65,
    description:
      "The Nike Sportswear Club Fleece Hoodie provides soft comfort for street style. Made from soft fleece fabric, it keeps you warm in cool weather. The classic design is versatile enough for everyday wear.",
  ...
  },
  {
    ...
    price: 175,
    description:
      "One of the most iconic sunglass models in the world, Ray-Ban Aviator Classic sunglasses were originally designed for U.S. Aviators in 1937. Aviator Classic sunglasses are a timeless model that combines great aviator styling with exceptional quality.",
  ...
  },
  {
    ...
    price: 680,
    description:
      "The Ace low-top sneaker is characterized by the House's Web stripe, an evolution of the original design debuted in the 1970s. The white leather design features the red and green web detail on the side and a contrasting heel detail.",
    ...
    features: [
      "White leather",
      "Green and red Web",
      "Red/Green metallic leather on heels",
      "Rubber sole",
    ],
    imageUrls: [
      "https://images.unsplash.com/photo-1560769629-975ec94e6a86?w=800&auto=format&fit=crop",
  ...
  },
  {
    ...
    price: 1200,
    description:
      "A symbol of Armani's tailoring excellence, this blazer is crafted from premium wool-blend fabric. It features a structured shoulder, slim lapels, and a tailored fit that provides an elegant silhouette for any formal or business occasion.",
  ...
  },
  {
    ...
    price: 98,
    description:
      "These slim-fitting jeans from Calvin Klein Jeans are crafted from stretch denim for everyday comfort. Featuring a classic 5-pocket styling and omega top-stitching on the back pockets, they are a versatile staple.",
...
async function bootstrap() {
  ...
  // Create Categories
  const categoryNames = ["Bags", "Clothing", "Shoes", "Accessories"];
